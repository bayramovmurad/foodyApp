            ...
            <table className="border-collapse bg-white w-full">
                ...
                <tbody>
                    <tr>
                        ...
                        <td className="border text-center p-1 overflow-x-auto whitespace-nowrap max-w-[130px] px-[10px]" >25 Dec 2021</td>
                        <td className="border text-center p-1 overflow-x-auto whitespace-nowrap max-w-[177px] px-[10px]">29 Eve Street, 543 Evenue Road, Ny 87876 </td>
                        ...
                        <td className="border text-center p-1 overflow-x-auto whitespace-nowrap h-[61px]">
                            <img src="/adminImg/OrderPage/Bin.svg" alt="" />
                        </td>
                    </tr>
                </tbody>
            </table>
