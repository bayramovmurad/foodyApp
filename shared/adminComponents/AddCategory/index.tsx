...
import { createCategory , createProduct } from '../../../services/index'
...
const AddCategory: React.FC<MenuTypes> = ({ right, callBack, headTitle }) => {
    //! States
    ...
    const saveData = async () => {
        if (formData.name == "" || formData.slug == "" || IMG == "") {
