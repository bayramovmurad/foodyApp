...
export const Header = ({ isLogin , isBasket , isAvatar , isName }:headerTypes) => {
    ...
    return (
        <header className="flex items-center justify-between pt-[36px] pb-[41px] pr-[89px] pl-[57px] rounded-s bg-[#f3f4f6] ">
            <div className="left">
            ...
            <div className="right flex items-center gap-5">
                ...
                <div onClick={handleActive} className="relative">
                        ...
                        {
                            isActive ? (
                                <div className={`flex flex-col absolute ${isActive ? "top-9 px-1" : ''}`}>
                                    {languages.map(lng => (
                    ...
                    {/* <div className="activeItem">
                        <img src="/mate/language/eng.svg" />
                    </div>
                    <div className="">
                        <img src="/mate/language/az.svg" />
                    </div> */}
                </div>

                {
                    !isLogin ? (
                        <button className="bg-[#D63626] hover:bg-[#a93c3c] py-[6.96px] pl-[22.96px] pr-[18px] text-white  rounded-[30px] ml-[27px]">
                            Sign Up
                        </button>
                    ) : (
                        <></>
