...
export const Header = ({ isLogin , isBasket , isAvatar , isName , isBottom }:headerTypes) => {
    ...
    return (
        <header className="flex flex-col  rounded-s bg-[#f3f4f6] ">
            <div className="top flex items-center justify-between pt-[36px] pb-[41px] pr-[89px] pl-[57px]">
                <div className="left">
            ...
            {
                isBottom ? (
                    <div className="bottom pr-[44px] pb-[162px] pl-[56px] flex items-center justify-between">
